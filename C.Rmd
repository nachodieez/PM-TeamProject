...
fit_pca2 <- princomp(x1_2)
new_x2 <- fit_pca2$scores[,1:n_pcs]

#esto era para verificar que prcomp y princomp daban lo mismo
...
both <- step(modZero, scope = list(lower = modZero, upper = modAll), direction = "both")
